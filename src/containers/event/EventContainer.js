        ...
        <div className={styles['container']}>
            <div className={styles['title-area']}>
                ...
                <div className={styles['mini-nav']}>
                    <span className={cn('mnav-item', { active: mode === 0 })}>진행 중인 이벤트</span>
                    <span onClick={() => alert('종료된 이벤트가 없습니다!')} className={cn('mnav-item', { active: mode === 1 })}>종료된 이벤트</span>
                </div>
            </div>
            <div className={styles['content']}>
                ...
                <>
                    <div className={styles['c-title-area']}>
                        ...
                        <p className={styles['c-enddate']}>{dateToYYYYMMDD(item.end_date, '/')}까지</p>
                    </div>
                ...
                list.map(({ id, images, warn, end_date }) => {
                    return (
                        <ButtonBase onClick={() => onClickDetail(id)} key={id} className={styles['item']}>
