...
const str =`이창훈 님 저희 아주나무 딜리버리 서비스를 이용해주셔서 감사합니다.
    ...
    return (
        <div className={styles['container']}>
            <div className={styles['content']}>
                <div className={styles['message']}>
                    ...
                    <div className={styles['btn']}>
                        <div className={styles['item']}>문구서비스 신청</div>
                    </div>
                </div>
            </div>
            <div className={styles['view-content']}>
                ...
                <OrderInfoBox text={"주문일시"} value={"2019-11-12 16:44:22"}/>
                <OrderInfoBox text={"결제방식"} value={"가상계좌 입금"}/>
                <OrderInfoBox text={"결제금액"} value={"101,000원"}/>
                <OrderInfoBox text={"입금자명"} value={"이창훈"}/>
                <OrderInfoBox text={"입금계좌"} value={"국민은행"}/>
                <OrderInfoBox text={""} value={"574845-23-568521 김종완"}/>
                <OrderInfoBox text={"가상계좌 유효기간"} auto={true} value={"2020년 06월 09일 00시 00분 00초"}/>
            ...
            <div className={styles['user-content']}>
                    <div className={styles['user-info']}>
                        ...
                        <div className={styles['context']}>
                             ...
                             <UserInfoBox text={"배달 요청 시간"} value={"2020년 05월 17일 오전 9시 30분"}/>
                             <UserInfoBox text={"배달 주소"} value={"서울특별시 구로구 구로동 557, 2층"}/>
                             <UserInfoBox text={"요청 사항"} value={"빨리 배달 해주세요~~"}/>
                        </div>
                    </div>
                    <div className={styles['user-info']}>
                        <div className={styles['title']}>
                    ...
                    <div className={styles['user-info']}>
                        ...
                        <div className={styles['context']}>
                             ...
                             <UserInfoBox text={"매장주소"} value={"서울특별시 구로구 구로동 557"}/>
...
function OrderInfoBox ({text,value ,auto}){
    return(
