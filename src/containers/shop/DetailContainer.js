...
const DetailContainer = ({ item_id }) => {
  ...
  const [item_options, setOptions] = useState([
    ...
    <div className={styles["container"]}>
      ...
      <div className={styles['content']}>
            ...
            <div className={styles['detail-info']}>
                <TabMenu tabs={[{name: "상세정보"},{name:"영양성분표"}]} index={0}/>
                ...
                <div className={styles['detail-text']}>
                    ...
                    제철 과일은 종류에 따라 당도가 높고, 가장 맛있는 맛을 내기 때문에 알맞은 때에 먹어주는 것이 좋습니다. <br/>
                   (쿠키 추가 가능 개당 1천 원) (불고기 샌드위치, 크랜베리 허니에그 샌드위치 변경가능 - 변경 시 단가 변동)
                    </div>
                </div>
                <TabMenu tabs={[{name: "상세정보"},{name:"영양성분표"}]} index={1}/>
